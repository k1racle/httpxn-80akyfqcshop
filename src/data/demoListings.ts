...
// ВАЖНО: ID категорий должны совпадать с Catalog.tsx
...
const categoryPriceRanges: Record<string, { min: number; max: number }> = {
  techpacks: { min: 2000000, max: 15000000 },
  "ai-models": { min: 1500000, max: 12000000 },
  software: { min: 500000, max: 8000000 },
  datasets: { min: 300000, max: 5000000 },
  patents: { min: 1000000, max: 20000000 },
  databases: { min: 800000, max: 6000000 },
  knowhow: { min: 500000, max: 10000000 },
  specifications: { min: 200000, max: 3000000 },
  trademarks: { min: 100000, max: 5000000 },
  copyrights: { min: 50000, max: 2000000 },
  "digital-twins": { min: 3000000, max: 25000000 },
  prototypes: { min: 2000000, max: 18000000 }
};
